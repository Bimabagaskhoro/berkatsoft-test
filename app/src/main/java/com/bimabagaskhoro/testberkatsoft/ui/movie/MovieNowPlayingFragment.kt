...
import com.bimabagaskhoro.testberkatsoft.databinding.FragmentMovieNowPlayingBinding
            ...
            when (it) {
                ...
                is Resource.Success -> {
                    ...
                    binding.apply {
                        ...
                        rvMovieNowPlaying.layoutManager = GridLayoutManager(context, 3)
                    ...
                    adapter.onItemClicked = {
                        ...
                        findNavController().navigate(
                            R.id.action_movieNowPlayingFragment_to_detailFragment,
                            bundle
                        )
                    }
                }
